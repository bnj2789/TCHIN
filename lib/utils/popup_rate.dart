...
///  POPUP ANIMÉE "FREE"
/// =============================
class PopupRateOverlay extends StatefulWidget {
  final double backgroundAlpha;

  const PopupRateOverlay({
    Key? key,
    this.backgroundAlpha = 0.0,
  }) : super(key: key);

  @override
  State<PopupRateOverlay> createState() => _PopupRateOverlayState();
}

class _PopupRateOverlayState extends State<PopupRateOverlay>
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            // Icône (exemple star)
                            Image.asset(
                              'assets/illustrations/prepaywall4rating.png',
                              width: 200,
                              height: 200,
                            ),
                            ...
                            /*
                            Text(
                              // loc?.popupGiftSubtitle ??
                              "Unlock 5 more debates",
                              textAlign: TextAlign.center,
                              ...
                              child: SizedBox(
                                ...
                                child: GestureDetector(
                                  onTap: () async {
                                    ...
                                    int spinCount = prefs.getInt('pickerSpinCount') ?? 0;
                                    await prefs.setBool('hasSeenRatePopup', true);
                                    await prefs.setInt('rateSpinNumber', spinCount);
                                    debugPrint('[RATE] Clicked OPEN → hasSeenRatePopup=true, rateSpinNumber=$spinCount');

                                    HapticFeedback.lightImpact();
                                    _closePopupWithAnimation();
                                    await Future.delayed(const Duration(milliseconds: 350));
                                    final url = Platform.isIOS
                                        ? 'https://apps.apple.com/fr/app/yadeba-1600-d%C3%A9bats-adultes/id6741700947'
