...
class ParticleBackgroundHome extends StatefulWidget {
  const ParticleBackgroundHome({super.key});

  @override
  State<ParticleBackgroundHome> createState() => _ParticleBackgroundHomeState();
}

class _ParticleBackgroundHomeState extends State<ParticleBackgroundHome>
...
class Particle {
  ...
  factory Particle.random({List<ui.Image>? images}) {
    ...
    final color = Colors.white.withOpacity(rand.nextDouble() * 0.10 + 0.20);
