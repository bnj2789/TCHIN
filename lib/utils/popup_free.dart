...
///  POPUP ANIMÉE "FREE"
/// =============================
class PopupFreeOverlay extends StatefulWidget {
  final double backgroundAlpha;

  const PopupFreeOverlay({
    Key? key,
    this.backgroundAlpha = 0.0,
  }) : super(key: key);

  @override
  State<PopupFreeOverlay> createState() => _PopupFreeOverlayState();
}

class _PopupFreeOverlayState extends State<PopupFreeOverlay>
