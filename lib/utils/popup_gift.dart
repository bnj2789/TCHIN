...
///  POPUP ANIMÉE "FREE"
/// =============================
class PopupGiftOverlay extends StatefulWidget {
  final double backgroundAlpha;

  const PopupGiftOverlay({
    Key? key,
    this.backgroundAlpha = 0.0,
  }) : super(key: key);

  @override
  State<PopupGiftOverlay> createState() => _PopupGiftOverlayState();
}

class _PopupGiftOverlayState extends State<PopupGiftOverlay>
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            // (Titre supprimé, ainsi que les SizedBox autour)
                              ...
                              child: SizedBox(
                                ...
                                child: GestureDetector(
                                  onTap: () async {
                                    ...
                                    if (mounted) {
                                      Navigator.of(context).pop(true); // simply close and return true
                                    }
                                  },
                                  child: Container(
                                    decoration: BoxDecoration(
