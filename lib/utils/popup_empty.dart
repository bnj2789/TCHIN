...
class PopupEmpty extends StatelessWidget {
  const PopupEmpty({super.key});

  @override
  Widget build(BuildContext context) {
    final t = AppLocalizations.of(context)!; // localisation
    return PopupInfo(
      iconPath: 'assets/illustrations/add_popup.png',
      title: t.popupEmptyTitle,
      subtitle: t.popupEmptySub,
      backgroundAlpha: 0.5,
    );
  }
}